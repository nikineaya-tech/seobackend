(function () {
  ...
  function linkItems(items, limit, sharedSeen) {
  ...
  function renderOpening(data, intel, offerType) {
    ...
    const quality = qualityModel(data, intel);
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #resultsCompetitors .daka-comp-quality-legend .tone-decision i { background: var(--daka-green); }
      #resultsCompetitors .daka-comp-quality-legend .tone-quality i { background: var(--daka-violet); }
      #resultsCompetitors .daka-comp-quality-legend .tone-details i { background: var(--daka-amber); }
      #resultsCompetitors .daka-comp-quality-sources { display: flex; align-items: center; gap: 10px; margin-top: 12px; flex-wrap: wrap; }
      #resultsCompetitors .daka-comp-quality-sources > span { color: #67e8f9; font-size: .7rem; font-weight: 800; }
      #resultsCompetitors .daka-comp-quality-sources > div { display: flex; gap: 6px; flex-wrap: wrap; }
      #resultsCompetitors .daka-comp-quality-sources > div span, #resultsCompetitors .daka-comp-quality-sources > div em { padding: 4px 8px; border: 1px solid rgba(125, 211, 252, .18); border-radius: 999px; background: rgba(15, 23, 42, .6); color: #cbd5e1; font-size: .68rem; font-style: normal; }
