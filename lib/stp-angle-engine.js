...
function buildPersonaReliabilityModel(persona = {}, angle = {}, { lang = 'fr', query = '', market = '', evidenceCatalog = [], competitorData = {}, constraintModel = {} } = {}) {
  ...
  const hypotheses = safeArray([
    details.ageRange || persona.ageRange ? pack(`Tranche d'age indicative: ${details.ageRange || persona.ageRange}`, `Indicative age range: ${details.ageRange || persona.ageRange}`, `فئة عمرية تقديرية: ${details.ageRange || persona.ageRange}`) : '',
