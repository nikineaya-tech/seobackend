const DETECTOR_SEQUENCE = [
  ...
  {
    key: 'offerSimilarityProofGaps',
    type: 'OFFER_SIMILARITY_PROOF_GAP',
    relationship: 'REPEATED offer features vs visible proof coverage',
    dimensions: ['COMPETITOR', 'OFFER', 'PROOF'],
    evidencePolicy: 'requires_multi_seller_feature_similarity_and_low_proof_coverage'
  },
  {
