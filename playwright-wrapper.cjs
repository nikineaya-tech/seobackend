...
const ENV = {
  BROWSERLESS_API_TOKEN:
    process.env.BROWSERLESS_API_TOKEN || process.env.BROWSERLESS_TOKEN || '',
  SCRAPE_DO_TOKEN:
    process.env.SCRAPE_DO_TOKEN || process.env.SCRAPEDOTOKEN || '',
  SERPAPI_KEY: process.env.SERPAPI_KEY || '',
  SERPER_API_KEY: process.env.SERPER_API_KEY || '',
  KEYWORDS_EVERYWHERE_KEY:
    process.env.KEYWORDS_EVERYWHERE_KEY || process.env.KE_API_KEY || '',
};
...
function isBrowserlessEnabled() {
  return !!ENV.BROWSERLESS_API_TOKEN;
}

function isScrapeDoEnabled() {
  return !!ENV.SCRAPE_DO_TOKEN;
}
